...
function nextPart(map) {
    ...
    const imageUrl = "../static/img/fond/" + nameMap[gameData.map - 1] + ".webp";
    if (gameData.currentPartIndex < storyDialogue[map - 1].length && gameData.gameOver === false) {
        ...
        newPerso1.style.backgroundImage = `url("../static/img/personnage/${personnages.perso1}.png")`;
        if (gameData.currentPartIndex === 0) {
        ...
        newPerso2.style.backgroundImage = `url("../static/img/personnage/${personnages.perso2}.png")`;
        ...
        const newPerso1 = document.getElementById("perso1")
        newPerso1.style.backgroundImage = `url("../static/img/personnage/${personnages.perso}.png")`;
...
function victoryMapStory() {
    ...
    if (gameData.map === 11) {
        // fin Story Victoire
        const imageUrl = "../static/img/fond/" + nameMap[9] + ".webp";
